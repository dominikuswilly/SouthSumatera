...
public class CardViewOkuSelatanAdapter extends RecyclerView.Adapter<CardViewOkuSelatanAdapter.CardViewViewHolder> {
    ...
    public CardViewOkuSelatanAdapter(List<Destination> listDestination) {
    ...
    public CardViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CardViewOkuSelatanAdapter.CardViewViewHolder cvh = new CardViewOkuSelatanAdapter.CardViewViewHolder(view);
