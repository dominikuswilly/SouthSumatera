...
public class CardViewPaliAdapter extends RecyclerView.Adapter<CardViewPaliAdapter.CardViewViewHolder> {
    private List<Destination> listDestination;
    private Context context;

    public CardViewPaliAdapter(List<Destination> listDestination) {
    ...
    public CardViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CardViewPaliAdapter.CardViewViewHolder cvh = new CardViewPaliAdapter.CardViewViewHolder(view);
