...
public class CardViewBanyuasinAdapter extends RecyclerView.Adapter<CardViewBanyuasinAdapter.CardViewViewHolder>{
    private List<Destination> listDestination;
    private Context context;

    public CardViewBanyuasinAdapter(List<Destination> listDestination){
    ...
    @Override
    public void onBindViewHolder(@NonNull CardViewBanyuasinAdapter.CardViewViewHolder holder, int position) {
